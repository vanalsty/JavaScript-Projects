...
const Calculator = {
    ...
    First_Operand: null, // this will hold the first operand for any expressions, we set it ot null for now
    Wait_Second_Operand: false, // This checks whether or not the second operand has been input
    operator: null, // this will hold the operator, we set to null for now
};
...
// this section hadles decimal points
...
keys.addEventListener('click', (event) => {
    ...
    // that was clicked
    const { target } = event;
    //if the lement that was clicked on is not a button, exit the function
    ...
    //ensurs that AC clearns the numbers from the calculator
