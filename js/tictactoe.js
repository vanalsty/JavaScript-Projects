...
function checkWinCon1(info, squareArray) {
    var winDetected = "on";
    var winCon1 = [0,1,2];
    // iterate through the gorwing array during
    ...
    if (match0Avatar != undefined && match1Avatar != undefined && match2Avatar != undefined) {
        if (match0Avatar == match1Avatar && match0Avatar == match2Avatar) {
            winDetected = "win"; // this flag will pas when win has been detected
...
function square2Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "1"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square3Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "2"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square4Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "3"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square5Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "4"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square6Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "5"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square7Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "6"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square8Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "7"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
...
function square9Animate() {
    var activePlayer = document.getElementById('showPlayer').innerHTML;
    if (activePlayer != "Game Stopped") { //if game has not yet started prevenet avatar placement
        var square = "8"; // indentify the square selected
        //check if the proposed square is valid
        var verdict = recordMoves(square);
        if (verdict == undefined) { //if verdict is empty then the square is unoccupied
            var paintAvatar = determineAvatar(); //gets the correct avatar to paint for the active player
